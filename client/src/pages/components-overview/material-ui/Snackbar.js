        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={6}>
            <Block title="Simple" sx={style}>
              ...
              <MButton variant="contained" color="info" onClick={() => enqueueSnackbar('This is an info', { variant: 'info' })}>
                Info
              </MButton>
              <MButton
                variant="contained"
              ...
              <MButton variant="contained" color="error" onClick={() => enqueueSnackbar('This is an error', { variant: 'error' })}>
                Error
              </MButton>
            </Block>
          </Grid>
