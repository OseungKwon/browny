    ...
    <Stack spacing={3}>
      ...
      <div>
        ...
        <Paper variant="outlined" sx={style}>
          ...
          <MChip variant="outlined" icon={<FaceIcon />} label="Success deletable" onDelete={handleDelete} color="success" />

          <MChip variant="outlined" clickable icon={<FaceIcon />} label="Success clickable" onDelete={handleDelete} color="success" />

          <MChip variant="outlined" icon={<FaceIcon />} label="Warning deletable" onDelete={handleDelete} color="warning" />

          <MChip variant="outlined" clickable icon={<FaceIcon />} label="Warning clickable" onDelete={handleDelete} color="warning" />

          <MChip variant="outlined" icon={<FaceIcon />} label="Error deletable" onDelete={handleDelete} color="error" />

          <MChip variant="outlined" clickable icon={<FaceIcon />} label="Error clickable" onDelete={handleDelete} color="error" />
        </Paper>
      </div>
      ...
      <div>
        ...
        <Paper variant="outlined" sx={style}>
          ...
          <MChip variant="outlined" size="small" avatar={<Avatar>M</Avatar>} label="Small" onDelete={handleDelete} color="info" />
        </Paper>
      </div>
    </Stack>
  );
