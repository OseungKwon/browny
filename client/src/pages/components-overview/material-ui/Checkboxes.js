            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <Block title="Size & Custom Icon" sx={style}>
                  ...
                  <FormControlLabel
                    control={
                      <MCheckbox size="small" color="error" icon={<Icon icon={awardFill} />} checkedIcon={<Icon icon={awardFill} />} />
                    }
                    label="Custom icon"
                  />
                </Block>
                  ...
                  <Grid container>
                    <Grid item xs={12} sm={6}>
                      <FormGroup>
                        ...
                        <FormControlLabel disabled control={<MCheckbox defaultChecked color="error" />} label="Disabled" />
                      </FormGroup>
                    </Grid>
                    ...
                    <Grid item xs={12} sm={6}>
                      <FormControl component="fieldset">
                        <FormGroup>
                          <FormControlLabel control={<Checkbox defaultChecked indeterminate color="default" />} label="Default" />
                          <FormControlLabel control={<Checkbox defaultChecked indeterminate />} label="Primary" />
                          <FormControlLabel control={<MCheckbox defaultChecked indeterminate color="secondary" />} label="Secondary" />
                          <FormControlLabel control={<MCheckbox defaultChecked indeterminate color="info" />} label="Info" />
                          <FormControlLabel control={<MCheckbox defaultChecked indeterminate color="success" />} label="Success" />
                          <FormControlLabel control={<MCheckbox defaultChecked indeterminate color="warning" />} label="Warning" />
                          <FormControlLabel control={<MCheckbox defaultChecked indeterminate color="error" />} label="Error" />
                          <FormControlLabel disabled control={<MCheckbox defaultChecked indeterminate color="error" />} label="Disabled" />
                        </FormGroup>
                      </FormControl>
                    </Grid>
                  </Grid>
