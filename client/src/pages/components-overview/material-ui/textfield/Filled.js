    ...
    <Stack spacing={3} direction={{ xs: 'column', md: 'row' }}>
      <Stack spacing={3} sx={{ width: 1 }}>
        ...
        <Block title="With Caption" sx={style}>
          <TextField fullWidth label="Error" variant="filled" defaultValue="Hello Minimal" helperText="Incorrect entry." />
          <TextField error fullWidth label="Error" variant="filled" defaultValue="Hello Minimal" helperText="Incorrect entry." />
        </Block>
      </Stack>
      ...
      <Stack spacing={3} sx={{ width: 1 }}>
        <Block title="Type" sx={style}>
          <TextField fullWidth type="password" label="Password" variant="filled" autoComplete="current-password" />
          <TextField fullWidth type="number" label="Number" defaultValue={0} variant="filled" InputLabelProps={{ shrink: true }} />
        ...
        <Block title="Multiline" sx={style}>
          <TextField fullWidth label="Multiline" multiline maxRows={4} value="Controlled" onChange={handleChange} variant="filled" />
