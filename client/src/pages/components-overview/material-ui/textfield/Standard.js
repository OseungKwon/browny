    ...
    <Stack spacing={3} direction={{ xs: 'column', md: 'row' }}>
      <Stack spacing={3} sx={{ width: 1 }}>
        ...
        <Block title="With Caption" sx={style}>
          <TextField fullWidth variant="standard" label="Error" defaultValue="Hello Minimal" helperText="Incorrect entry." />
          <TextField error fullWidth variant="standard" label="Error" defaultValue="Hello Minimal" helperText="Incorrect entry." />
        </Block>
      </Stack>
      ...
      <Stack spacing={3} sx={{ width: 1 }}>
        <Block title="Type" sx={style}>
          ...
          <TextField fullWidth variant="standard" type="number" label="Number" defaultValue={0} InputLabelProps={{ shrink: true }} />
        ...
        <Block title="Multiline" sx={style}>
          <TextField fullWidth variant="standard" label="Multiline" multiline maxRows={4} value="Controlled" onChange={handleChange} />
