    ...
    <RootStyle title="Mega Menu | Minimal-UI">
      ...
      >
        <Container maxWidth="lg">
          <HeaderBreadcrumbs heading="Mega Menu" links={[{ name: 'Components', href: PATH_PAGE.components }, { name: 'Mega Menu' }]} />
        </Container>
      </Box>
      ...
      <Container sx={{ mt: 10 }}>
        ...
        <Stack direction="row" spacing={3} mt={5}>
          ...
          <Paper sx={{ minHeight: 480, overflow: 'hidden', borderRadius: 1 }}>
            <Box component="img" src="/static/mock-images/feeds/feed_8.jpg" sx={{ height: '100%', objectFit: 'cover' }} />
          </Paper>
        </Stack>
      </Container>
    </RootStyle>
