...
import { BlogPostHero, BlogPostTags, BlogPostRecent, BlogPostCommentList, BlogPostCommentForm } from '../../components/blog';
    ...
    <Page title="Blog: Post Details | Minimal-UI">
      <Container>
        <HeaderBreadcrumbs
          ...
          links={[{ name: 'Dashboard', href: PATH_BLOG.root }, { name: 'Blog', href: PATH_BLOG.root }, { name: sentenceCase(title) }]}
        />
