  ...
  return (
    <Container maxWidth="lg" sx={{ pb: 10, textAlign: 'center' }}>
      ...
      <MotionInView variants={varFadeInUp}>
        ...
        >
          Minimal will provide you support if you have any problems, our support team will reply within a day and we also have detailed
          documentation.
        </Typography>
      </MotionInView>
      ...
      <Box sx={{ position: 'relative' }}>
        ...
        <CarouselControlsArrowsBasic2 onNext={handleNext} onPrevious={handlePrevious} sx={{ transform: 'translateY(-64px)' }} />
      </Box>
      <Button
        variant="outlined"
        color="inherit"
