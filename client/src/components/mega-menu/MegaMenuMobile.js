  ...
  if (children) {
    return (
      <>
        ...
        <Drawer open={open} onClose={handleClose} ModalProps={{ keepMounted: true }} PaperProps={{ sx: { width: DRAWER_WIDTH - 12 } }}>
              ...
              {children.map((list) => {
                ...
                return (
                  <List key={subheader} disablePadding>
                    ...
                    {items.map((link) => (
                      <ListItem button disableGutters key={link.title} component={RouterLink} to={link.path} sx={{ px: 1.5 }}>
                        <ListItemIcon
                          sx={{
                            mr: 0.5,
                            width: ICON_SIZE,
                        ...
                        <ListItemText primary={link.title} primaryTypographyProps={{ typography: 'body2', noWrap: true }} />
                      </ListItem>
                    ))}
                  </List>
                );
