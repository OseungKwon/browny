...
export default function KanbanColumn({ column, index }) {
  ...
  return (
    <Draggable draggableId={id} index={index}>
      {(provided) => (
        <Paper {...provided.draggableProps} ref={provided.innerRef} variant="outlined" sx={{ px: 2, bgcolor: 'grey.5008' }}>
          <Stack spacing={3} {...provided.dragHandleProps}>
            <KanbanColumnToolBar columnId={id} columnName={name} onDelete={handleDeleteColumn} onUpdate={handleUpdateColumn} />
