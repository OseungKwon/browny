...
import { Box, Stack, Drawer, Button, Avatar, Tooltip, Divider, MenuItem, TextField, Typography, OutlinedInput } from '@material-ui/core';
//
...
export default function KanbanTaskDetails({ card, isOpen, onClose, onDeleteTask }) {
  ...
  const { dueDate, startTime, endTime, isSameDays, isSameMonths, onChangeDueDate, openPicker, onOpenPicker, onClosePicker } = useDatePicker(
    {
      date: due,
    },
  );
